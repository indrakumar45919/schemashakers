                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" name="book" method="post">
                                ...
                                <div class="form-group">
                                    <label for="DoctorSpecialization">👨‍⚕️ Doctor Specialization</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="apptime" id="timepicker1" required placeholder="e.g. 10:00 PM">
                                </div>
